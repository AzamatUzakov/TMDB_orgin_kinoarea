...
let Auto_res = {
  headers: {
    Authorization:
      "Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI2ZWIwNmU5YzExYTA2NzFmNmFhYjUwNzU4ZjBhYzczMSIsInN1YiI6IjY0ZDg5YjVlZjQ5NWVlMDI5NDMwNWM0MCIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.aoDhRlGV-Iv_PiTmdIt1LCgA7Ho2vh4aV50M04VXY7M",
  },
};
...
function reload_NowPlaying(arr) {
  ...
  for (let item of arr.slice(0, toShow)) {
    ...
    poster_img.onmouseenter = () => {
      ...
      setTimeout(() => {
        rear_background.style.backgroundImage = `url(${
          PICTURE_URL + item.backdrop_path
        })`;
